...
Alfred doesn't guess. It watches. Observations come from two sources:
...
|-----------|-----------|-----------------|
| Fewer than 5 observations | Very cautious | "I've barely seen this before, sir. Your guidance?" |
| 5-9 observations | Cautious | "I believe I know, but I'd rather confirm." |
| 10-19 observations | Moderate | "I'm fairly certain this goes here." |
| 20-49 observations | Confident | "I've seen this many times. Handling it." |
| 50+ observations | Routine | "This is routine. Already done." |
...
Intuition runs on six automated processes. You don't need to manage them — they run on schedules and take care of themselves.

| Process | Schedule | What it does |
|---------|----------|-------------|
| **Event Processor** | Every 2 minutes | Reads incoming stream events, classifies them, and writes vault records |
...
All six processes are managed by the Temporal Engine and can be monitored from the Workflows section of your dashboard.
...
Disabling pauses all six processes but preserves your existing observations and instincts. Re-enabling picks up where Alfred left off.
