...
|-------|------|------|
| **Curator** | Processes manual inbox uploads into structured records | When files are dropped into the inbox |
...
Go to your [Alfred Black dashboard](https://alfred.black) and check the **Command Center** — it shows the status of each specialist at a glance.
