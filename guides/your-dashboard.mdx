...
- **Streams** — View and manage data pipelines feeding Alfred ([learn more](/architecture/data))
...
For a full guide, see [Streams & Integrations](/guides/streams-and-integrations).
