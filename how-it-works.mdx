...
Temporal is the workflow engine. It orchestrates every specialist, intuition process, and action Alfred takes. The Kinetic layer is built around three core concepts: **Matters** (standing concerns that group related work, like "Kitchen renovation"), **Errands** (actionable tasks with an owner and status lifecycle), and **Triage** (items the Curator flagged for your review before processing — you promote them to tasks or dismiss them). Together they turn vault knowledge into proactive service.

<Card title="Kinetic Layer" icon="gears" href="/architecture/kinetic">
  Temporal engine, Matters, Errands, Triage, Chores, Rules, and the thirteen background processes.
</Card>
