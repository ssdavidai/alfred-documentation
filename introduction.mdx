...
Each Alfred instance runs on a dedicated server, accessible exclusively through your [Tailscale](https://tailscale.com) mesh network. Everything — from dropping files into the inbox to managing Temporal workflows — is available through the REST API documented here.
...
<Columns cols={2}>
  ...
  <Card title="Administer the instance" icon="server" href="/api-reference/admin/health">
    Manage containers, environment config, Tailscale networking, backups, and system health.
  </Card>
  <Card title="Stream logs" icon="scroll" href="/api-reference/logs/stream">
