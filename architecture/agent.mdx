...
|-----------|-------------|------|
| **Curator** | Processes manual inbox uploads into structured vault records | When files are dropped into the inbox |
...
Beyond the five specialists, Alfred's main agent (the one that handles your conversations) has access to **45+ tools** across six categories:
