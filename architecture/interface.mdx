...
description: "Every way you interact with Alfred: dashboard, channels, Talk Mode, Ambient Mode, and the API."
icon: "display"
---
...
Alfred Talk gives your Alfred a voice. Alfred can call you for briefings, reminders, and check-ins — and you can call Alfred's dedicated phone number any time you need something.
...
<Accordion title="Setting up Alfred Talk" icon="sliders">
...
2. Toggle Alfred Talk on — Alfred provisions your dedicated phone number automatically
