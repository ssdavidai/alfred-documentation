...
<AccordionGroup>
<Accordion title="Standing entities (7) — the stable elements of your world" icon="building">
...
<Accordion title="Activity records (7) — what happened" icon="calendar">
Events, work, and interactions — capturing what occurred and linking to the people and things involved.
