...
| Stream Pullers | Every 2–10 min per stream | Polls connected apps via Composio for new data |
...
| Process | Schedule | What it does |
|---------|----------|-------------|
| Nightly Maintenance | Daily at 3am | Vault cleanup, stream pruning, index rebuilds |
